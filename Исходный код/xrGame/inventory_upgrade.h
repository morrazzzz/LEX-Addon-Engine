...
enum EMaxProps
{
	// Lex Addon (correct by Suhar_) 22.07.2016		(begin)
	// Увеличиваем максимальное число отображаемых свойств у апгрейда с 3 до 20
	max_properties_count = 20,
	// Lex Addon (correct by Suhar_) 22.07.2016		(end)
};
