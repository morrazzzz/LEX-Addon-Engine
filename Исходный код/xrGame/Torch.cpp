...
CTorch::CTorch(void) 
{
	...
	// По умолчанию ПНВ, встроенный в прицел, должен быть активен
	EnableWeaponNightVision		= true;
	// Lex Addon (correct by Suhar_) 23.04.2016		(end)
...
void CTorch::UpdateCL()
{
	...
	// Код правки заимствован у проекта X-Ray Oxygen 
	inherited::UpdateCL();
