...
public:
	...
	//работа с заданиями
			...
			// Lex Addon (correct by Suhar_) 26.02.2017		(begin)
			// Добавлена функция перебора предметов на поясе
			void				IterateBelt			(luabind::functor<void> functor, luabind::object object);
			// Lex Addon (correct by Suhar_) 26.02.2017		(end)
