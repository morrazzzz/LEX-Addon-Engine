...
void CUIMotionIcon::Init(Frect const& zonemap_rect)
{
	...
	// По умолчанию устанавливаем индикатор видимости на 0;
	// ранее отсутствие этой строки приводило к неверному отображению индикатора в момент загрузки сохранения
