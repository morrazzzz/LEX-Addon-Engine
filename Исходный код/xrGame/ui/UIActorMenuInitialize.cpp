...
//	m_PartnerTradeCaption->AdjustWidthToText();
	...
	m_InvSlotKnifeHighlight		= UIHelper::CreateStatic(uiXml, "knife_slot_highlight", this);
	m_InvSlotKnifeHighlight		->Show(false);
	// Подсветка слота бинокля
	m_InvSlotBinocularHighlight	= UIHelper::CreateStatic(uiXml, "binocular_slot_highlight", this);
