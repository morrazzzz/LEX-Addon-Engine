...
void CUITaskWnd::ReloadTaskInfo()
{
	...
	for(;b!=e;b++)
	{
		...
		// Расширен список иконок тайников и важных объектов для фильтров на карте КПК
		shared_str spot = b->spot_type;
		if (spot=="treasure" || spot=="treasure_blue" || spot=="treasure_red" || spot=="treasure_yellow" || spot=="treasure_violet")
			...
			spot=="ui_pda2_actor_sleep_location" || spot=="explosive_mark")
