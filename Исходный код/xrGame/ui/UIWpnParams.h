...
protected:
	...
	// Регистрируем необходимые переменные (иконки, заголовки, ползунки)
	CUIDoubleProgressBar	m_progressBulletSpeed;
	...
	CUIStatic				m_icon_spe;
	CUIStatic				m_icon_rec;
