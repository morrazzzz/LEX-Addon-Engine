...
public:
	...
	// Добавляем чтение параметра дополнительной скорости прыжка из свойств артефакта 6.07.2016
	float							m_fJumpSpeedAdd;
	// Добавляем чтение параметра дополнительной скорости передвижения из свойств артефакта
