...
{
	// Lex Addon (correct by Suhar_) 25.09.2018		(begin)
	// Обход вылета из-за конфилкта наличия положительного здоровья у погибших
	...
	// Lex Addon (correct by Suhar_) 25.09.2018		(end)
