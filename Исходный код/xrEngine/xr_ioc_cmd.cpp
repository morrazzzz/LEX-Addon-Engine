...
//	CMD4(CCC_Integer,	"rs_ib_size",			&rsDIB_Size,		32,		4096);
	...
	// Lex Addon (correct by Suhar_) 14.11.2018		(begin)
	// Расширения пула звуков
	...
	CMD4(CCC_Integer,	"snd_targets",			&psSoundTargets,	4,128		);
	CMD4(CCC_Integer,	"snd_cache_size",		&psSoundCacheSizeMB,4,128		);
	// Lex Addon (correct by Suhar_) 14.11.2018		(end)
	...
	// Lex Addon (correct by Suhar_) 23.09.2018		(begin)
	// Задаём возможность управлять fov из меню настроек
	CMD4(CCC_Float,		"base_fov",				&m_fBaseFov,		40.0f, 80.0f);
	// Задаём возможность управлять дальностью положения рук из меню настроек
	CMD4(CCC_Float,		"hud_fov",				&psHUD_FOV,			0.20f, 1.00f);
	// Lex Addon (correct by Suhar_) 23.09.2018		(end)
